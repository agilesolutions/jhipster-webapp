  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="webappApp.category.home.createOrEditLabel">
            <Translate contentKey="webappApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : categoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="category-description">
                  <Translate contentKey="webappApp.category.description">Description</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="sortOrderLabel" for="category-sortOrder">
                  <Translate contentKey="webappApp.category.sortOrder">Sort Order</Translate>
                </Label>
              ...
              <AvGroup>
                <Label id="dateAddedLabel" for="category-dateAdded">
                  <Translate contentKey="webappApp.category.dateAdded">Date Added</Translate>
                </Label>
              ...
              <AvGroup>
                <Label id="dateModifiedLabel" for="category-dateModified">
                  <Translate contentKey="webappApp.category.dateModified">Date Modified</Translate>
                </Label>
              ...
              <AvGroup>
                <Label id="statusLabel" for="category-status">
                  <Translate contentKey="webappApp.category.status">Status</Translate>
                </Label>
                <AvInput
                  id="category-status"
                  type="select"
                ...
                >
                  <option value="AVAILABLE">{translate('webappApp.CategoryStatus.AVAILABLE')}</option>
                  <option value="RESTRICTED">{translate('webappApp.CategoryStatus.RESTRICTED')}</option>
                  <option value="DISABLED">{translate('webappApp.CategoryStatus.DISABLED')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label for="category-parent">
                  <Translate contentKey="webappApp.category.parent">Parent</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="category-product">
                  <Translate contentKey="webappApp.category.product">Product</Translate>
                </Label>
                <AvInput
                  id="category-product"
                  type="select"
