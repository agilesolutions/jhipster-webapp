  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="webappApp.customer.home.createOrEditLabel">
            <Translate contentKey="webappApp.customer.home.createOrEditLabel">Create or edit a Customer</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
